...
namespace SystemIntelligencePlatform.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppFailedLogEvents",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    OriginalMessageBody = table.Column<string>(type: "text", nullable: false),
                    ...
                    CorrelationId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    DeliveryAttempt = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFailedLogEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HashSignature = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ...
                    KeyPhrases = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    Entities = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ...
                    SeverityJustification = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIncidents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMonitoredApplications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWebhookRegistrations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIncidentComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppIncidentComments_AppIncidents_IncidentId",
                        column: x => x.IncidentId,
                        principalTable: "AppIncidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppFailedLogEvents_CreationTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppIncidentComments_IncidentId",
                table: "AppIncidentComments",
                column: "IncidentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppIncidents_ApplicationId_HashSignature",
                table: "AppIncidents",
                columns: new[] { "ApplicationId", "HashSignature" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppIncidents_LastOccurrence",
                table: "AppIncidents",
                column: "LastOccurrence");

            migrationBuilder.CreateIndex(
                name: "IX_AppIncidents_Severity",
                table: "AppIncidents",
                column: "Severity");

            migrationBuilder.CreateIndex(
                name: "IX_AppIncidents_Status",
                table: "AppIncidents",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLogEvents_ApplicationId_HashSignature_Timestamp",
                table: "AppLogEvents",
                columns: new[] { "ApplicationId", "HashSignature", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_AppLogEvents_IncidentId",
                table: "AppLogEvents",
                column: "IncidentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLogEvents_Timestamp",
                table: "AppLogEvents",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_AppMonitoredApplications_ApiKeyHash",
                table: "AppMonitoredApplications",
                column: "ApiKeyHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppMonitoredApplications_IsActive",
                table: "AppMonitoredApplications",
                column: "IsActive");
