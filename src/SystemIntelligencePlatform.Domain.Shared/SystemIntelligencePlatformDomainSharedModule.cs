...
public class SystemIntelligencePlatformDomainSharedModule : AbpModule
{
    ...
    {
        SystemIntelligencePlatformGlobalFeatureConfigurator.Configure();
        SystemIntelligencePlatformModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SystemIntelligencePlatformDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SystemIntelligencePlatformResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SystemIntelligencePlatform");

            options.DefaultResourceType = typeof(SystemIntelligencePlatformResource);
        ...
        {
            options.MapCodeNamespace("SystemIntelligencePlatform", typeof(SystemIntelligencePlatformResource));
        });
    }
}
