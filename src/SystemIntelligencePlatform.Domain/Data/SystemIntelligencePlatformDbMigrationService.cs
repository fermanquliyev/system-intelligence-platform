...
public class SystemIntelligencePlatformDbMigrationService : ITransientDependency
{
    public ILogger<SystemIntelligencePlatformDbMigrationService> Logger { get; set; }
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            ...
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName,
                SystemIntelligencePlatformConsts.AdminPasswordDefaultValue)
        );
    }
