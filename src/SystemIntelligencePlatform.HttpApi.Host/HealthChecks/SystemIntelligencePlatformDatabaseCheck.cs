...
public class SystemIntelligencePlatformDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SystemIntelligencePlatformDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
